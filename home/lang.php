<?php
    ...
    if($_SESSION['co_code'] == 'TW'){
        $_SESSION['price'] = '63,15 TWD';
    }else if($_SESSION['co_code'] == 'QA'){
        $_SESSION['price'] = '7,25 QAR';
    }else if($_SESSION['co_code'] == 'SA'){
        $_SESSION['price'] = '7,47 SAR';
    }else if($_SESSION['co_code'] == 'TH'){
        $_SESSION['price'] = '69,83 THB';
    }else if($_SESSION['co_code'] == 'JP'){
        $_SESSION['price'] = '281.89 JPY';
    }else if($_SESSION['co_code'] == 'CN'){
        $_SESSION['price'] = '14.30 CNY';
    }else{
        $_SESSION['price'] = '$1,99';
    }
    ...
    $lang = array(
        ...
        "ar" => "({$_SESSION['price']}) يتطلب رسوم الشحن",
        ...
        "copyright" => array(
            "en" => "{$year} © DHL International GmbH. All rights reserved",
            "zh-TW" => "{$year} © DHL International GmbH。版權所有",
            "th" => "{$year} © DHL International GmbH สงวนลิขสิทธิ์ทั้งหมด",
            "ar" => "{$year} © DHL International GmbH. جميع الحقوق محفوظة",
            "ja" => "{$year} © DHL International GmbH. All rights reserved",
        ),
        "title2" => array(
            "en" => "Shipment On Hold",
            "zh-TW" => "運送暫停",
        ...
        "total" => array(
            ...
            "ar" => "<b> $ 1.99 </b> :الإجمالي",
            "ja" => "合計： <b> 281.89 JPY </b>",
        ),
        "parcel" => array(
            "en" => "This shipment is handled by: <b>DHL EXPRESS</b>",
            "zh-TW" => "此貨物由： <b>DHL EXPRESS</b> 處理",
            "th" => "การส่งของนี้จัดการโดย： <b>DHL EXPRESS</b>",
            "ar" => "تم التعامل مع هذه الشحنة بواسطة: <b>DHL EXPRESS</b>",
            "ja" => "この出荷は<b>DHL EXPRESS</b>が取り扱っています",
        ),
        ...
        "address_message" => array(
            "en" => "We need your Address to be sure that unauthorized persons cannot access your packages, You have 10 working days From the arrival of your package to the DHL branch after this time the package will be returned to the ser.",
        ...
        "sms-message" => array(
            ...
            "ar" => "إلى رقم هاتفك (OTP) تم إرسال رمز التحقق",
